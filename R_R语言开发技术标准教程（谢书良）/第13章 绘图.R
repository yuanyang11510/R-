...
# R语言具有强大的绘图功能，可以通过绘图函数来实现。下面先简单介绍散点图、饼图、直方图、三维透视图、等高线图和色彩影像图6种。
    ...
    # 13.6 图形参数
        ...
        # 4. 规定图中点、线、文本或者填充区域的颜色
            ...
            # 关于颜色的相关函数，可以参考：https://zhuanlan.zhihu.com/p/35366657

        # 5. 规定图中文本的对齐方式
            # 可用参数adj（adjustment）规定图中文本的对齐方式：
            # adj = k
            # 其中k为数值，表示对齐的方式：0表示左对齐，1表示右对齐，0.5表示居中。此参数的值实际代表的是出现在给定坐标左边的文本比例
            # adj参数的应用可以参见对于text()函数的介绍，参考：https://www.biye5u.com/article/R/2018/6381.html
        ...
        # 7. 添加图题
            ...
            # 可以参考：https://www.cnblogs.com/xudongliang/p/6757195.html
